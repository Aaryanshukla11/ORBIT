...
class AbstractActionType(str, Enum):
    """Controlled vocabulary of atomic agent actions generated by the AI / Cognitive layer."""

    LAUNCH_APPLICATION = "LAUNCH_APPLICATION"
    FOCUS_WINDOW = "FOCUS_WINDOW"
    CLICK = "CLICK"
    CLICK_ELEMENT = "CLICK_ELEMENT"  # Alias
    ...
    ABORT = "ABORT"  # Alias
    ABORT_UNACHIEVABLE = "ABORT_UNACHIEVABLE"  # Alias
...
class AgentActionValidator:
    ...
    def _validate_parameters_for_type(cls, action_type: AbstractActionType, params: Dict[str, Any]) -> Optional[str]:
        ...
        try:
            ...
            elif action_type in (AbstractActionType.TYPE_TEXT, AbstractActionType.TYPE):
                if "text" not in params and "query" not in params:
                    return "Missing required parameter 'text'"
            elif action_type in (AbstractActionType.SEND_HOTKEY, AbstractActionType.HOTKEY):
