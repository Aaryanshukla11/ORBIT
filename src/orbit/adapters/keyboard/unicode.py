"""Sequence-Level Unicode & UTF-16 Surrogate Pair Engine for ORBIT Keyboard."""
...
class UnicodeMatchOutcome(str, Enum):
    EXACT_MATCH = "EXACT_MATCH"
    NORMALIZATION_EQUIVALENT = "NORMALIZATION_EQUIVALENT"
