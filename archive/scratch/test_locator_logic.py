...
def poll_and_resolve_window(target_query: str, timeout: float = 3.0) -> Optional[ObservedWindow]:
    ...
    # Disambiguate / pick best candidate:
    # 1. Non-empty title
    # 2. Title contains query
    # 3. Largest visible area
    # 4. Foreground
    ...
    # Bring to foreground
    user32.ShowWindow(best_win.hwnd, 9) # SW_RESTORE = 9
