"""Production Live Windows Validation: Paint Multi-Step Autonomous Task (Step 5).

Executes:
"Open Paint and draw a simple red circle."
...
3. Physical Launch of Paint (mspaint.exe / Microsoft Paint)
4. Fresh Post-Action Observation & Immediate Verification (Paint window confirmed)
5. Model selects brush/color/canvas interaction based on live observation
6. Physical Pointer Drag / Stroke Trajectory Dispatch via Pointer Capability
7. Fresh Post-Action Observation (Visual delta verification on drawing canvas)
...
async def run_real_paint_validation():
    print("=" * 70)
    print("ORBIT STEP 5 — PRODUCTION CLOSED-LOOP REALITY VALIDATION: PAINT")
    print("=" * 70)
    print("Prompt: 'Open Paint and draw a simple red circle.'")
    ...
    res: AgentExecutionResult = await loop.run(
        prompt="Open Paint and draw a simple red circle.",
        task_id="real_paint_val_01",
    )
...
if __name__ == "__main__":
    asyncio.run(run_real_paint_validation())
